...
public class MessageSerializationTests
{
    ...
    [Fact(DisplayName = "Round-trip SCHEMA_RES serialization with JSON")]
    ...
    [Fact(DisplayName = "Round-trip QUERY_RES serialization with JSON")]
    ...
    public void DeterminePreambleOnHelloReq()
    {
        ...
        var preamble = serialization.Bind(new JsonSerializationProvider().DetermineMessagePreamble).Data;

...
using Janus.Mask.LiteDB.WebApp;
...
builder.Services.AddSingleton<LiteDbQueryTranslator>();
builder.Services.AddSingleton<LiteDbCommandTranslator>();
builder.Services.AddSingleton<LiteDbSchemaTranslator>();

builder.Services.AddSingleton<LiteDbMaskQueryManager>();
builder.Services.AddSingleton<LiteDbMaskCommandManager>();
builder.Services.AddSingleton<LiteDbMaskSchemaManager>();
...
builder.Services.AddSingleton<LiteDbMaskOptions>(maskConfiguration.ToMaskOptions());

builder.Services.AddSingleton<LiteDbMaskManager>();
...
var manager = app.Services.GetService<LiteDbMaskManager>();

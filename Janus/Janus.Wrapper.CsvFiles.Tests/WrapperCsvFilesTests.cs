        ...
        var expectedSchemaModel = SchemaModelBuilder.InitDataSource("DataSet")
            .AddSchema("CarsSchema", 
                conf => conf.AddTableau("cars", conf => conf.AddAttribute("Car", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(0))
                                                            .AddAttribute("MPG", conf => conf.WithDataType(DataTypes.INT).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(1))
                                                            .AddAttribute("Cyclinders", conf => conf.WithDataType(DataTypes.INT).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(2))
                                                            ...
                                                            .AddAttribute("Horsepower", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(4))
                                                            .AddAttribute("Weight", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(5))
                                                            .AddAttribute("Acceleration", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(6))
            ...
            .AddSchema("CerealSchema",
                conf => conf.AddTableau("cereal", conf => conf.AddAttribute("name", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(0))
                                                              ...
                                                              .AddAttribute("rating", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(15))))
            .AddSchema("MiscSchema", 
                conf => conf.AddTableau("factbook", conf => conf.AddAttribute("Country", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(0))
                                                                ...
                                                                .AddAttribute("Death rate(deaths/1000 population)", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(4))
                                                                ...
                                                                .AddAttribute("GDP - real growth rate(%)", conf => conf.WithDataType(DataTypes.DATETIME).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(11))
                                                                ...
                                                                .AddAttribute("Inflation rate (consumer prices)(%)", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(19))
                                                                ...
                                                                .AddAttribute("Military expenditures - percent of GDP(%)", conf => conf.WithDataType(DataTypes.STRING).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(26))
                                                                ...
                                                                .AddAttribute("Total fertility rate(children born/woman)", conf => conf.WithDataType(DataTypes.DATETIME).WithIsPrimaryKey(false).WithIsNullable(true).WithOrdinal(43))

...
{
    public IncompatibleInstantiationDataTypesException(TableauId tableauId, string referencedAttribute, DataTypes referencedDataType, DataTypes referencingDataType)

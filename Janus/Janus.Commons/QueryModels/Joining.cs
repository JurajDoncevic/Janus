...
public sealed class Join
{
    ...
    /// Constructor
    /// </summary>
    /// <param name="foreignKeyAttributeId">Foreign key attribute id</param>
    /// <param name="primaryKeyAttributeId">Primary key attribute id</param>
    /// <exception cref="ArgumentException"></exception>
    internal Join(AttributeId foreignKeyAttributeId, AttributeId primaryKeyAttributeId)
    {
        _primaryKeyAttributeId = primaryKeyAttributeId ?? throw new ArgumentNullException(nameof(primaryKeyAttributeId));
        _foreignKeyAttributeId = foreignKeyAttributeId ?? throw new ArgumentNullException(nameof(foreignKeyAttributeId));
    }
    ...
    {
        return $"{_foreignKeyAttributeId}->{_primaryKeyAttributeId}";
    }

    public static Join CreateJoin(AttributeId foreignKeyAttributeId, AttributeId primaryKeyAttributeId)
        => new Join(foreignKeyAttributeId, primaryKeyAttributeId);
}

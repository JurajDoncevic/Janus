...
public class ModelsSerializationTests
{
    ...
    [Fact(DisplayName = "Round-trip serialization of Query with Avro")]
    ...
    [Fact(DisplayName = "Round-trip serialization of TabularData with Avro")]
    ...
    [Fact(DisplayName = "Round-trip serialization of DeleteCommand with Avro")]
    ...
    [Fact(DisplayName = "Round-trip serialization of UpdateCommand with Avro")]
    ...
    [Fact(DisplayName = "Round-trip serialization of InsertCommand with Avro")]

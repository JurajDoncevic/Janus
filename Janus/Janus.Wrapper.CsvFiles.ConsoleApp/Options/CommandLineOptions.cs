...
namespace Janus.Wrapper.CsvFiles.ConsoleApp.Options;
public class CommandLineOptions
{
    ...
    [CommandLine.Option('d', "datasource", HelpText = "Data source path", SetName = "explicitConf")]
    ...
    public static IEnumerable<Example> Examples
    {
        get
        {
            ...
            new Example("Start with explicit arguments", new CommandLineOptions { NodeId = "SomeMediatorNode", ListenPort = 10000, TimeoutMs = 5000, DataSourcePath = "./DataSetDirectory/" })
            };
        }
    }
}
